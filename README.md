...
- Trivy se ejecuta dentro del agente Jenkins con `trivy image`, escanea paquetes del sistema operativo de la imagen y devuelve error si hay vulnerabilidades criticas.
