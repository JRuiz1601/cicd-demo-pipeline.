...
- Trivy se ejecuta dentro del agente Jenkins con `trivy image`, escanea paquetes del sistema operativo y dependencias Java de la imagen, y devuelve error si hay vulnerabilidades criticas.
